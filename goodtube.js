// ==UserScript==
// @name         GoodTube
// @description  A free Youtube adblocker. Removes 100% of Youtube ads and also removes shorts.
// @version      3.005
// @author       GoodTube
...
;(function () {
  ...
  var c = (r, o) => Xt(r, "name", { value: o, configurable: !0 })
  var {
      entries: gt,
      setPrototypeOf: ft,
      isFrozen: jt,
    ...
    { freeze: R, seal: b, create: ve } = Object,
    { apply: ke, construct: Ue } = typeof Reflect < "u" && Reflect
  R ||
    (R = c(function (o) {
      return o
    }, "freeze"))
  ...
  ke ||
    (ke = c(function (o, l) {
      for (
        var a = arguments.length, f = new Array(a > 2 ? a - 2 : 0), y = 2;
        y < a;
        y++
      )
        f[y - 2] = arguments[y]
  ...
  Ue ||
    (Ue = c(function (o) {
      for (
        var l = arguments.length, a = new Array(l > 1 ? l - 1 : 0), f = 1;
        f < l;
        f++
      )
        a[f - 1] = arguments[f]
  ...
  var fe = O(Array.prototype.forEach),
    qt = O(Array.prototype.lastIndexOf),
    ut = O(Array.prototype.pop),
    K = O(Array.prototype.push),
    Kt = O(Array.prototype.splice),
    me = O(String.prototype.toLowerCase),
    Ie = O(String.prototype.toString),
    Ce = O(String.prototype.match),
    Z = O(String.prototype.replace),
    Zt = O(String.prototype.indexOf),
    Jt = O(String.prototype.trim),
    D = O(Object.prototype.hasOwnProperty),
  ...
  c(Qt, "unconstruct")
  function s(r, o) {
    let l = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : me
    ft && ft(r, null)
    let a = o.length
    for (; a--; ) {
      let f = o[a]
  ...
  c(s, "addToSet")
  function en(r) {
    for (let o = 0; o < r.length; o++) D(r, o) || (r[o] = null)
    return r
  }
  c(en, "cleanArray")
  function w(r) {
  ...
  function Q(r, o) {
    for (; r !== null; ) {
      ...
      if (a) {
        ...
        if (typeof a.value == "function") return O(a.value)
      }
      r = Vt(r)
    }
    function l() {
  ...
  var mt = R([
    ...
    ue = R(["xlink:href", "xml:id", "xlink:title", "xml:space", "xmlns:xlink"]),
    on = b(/\{\{[\w\W]*|[\w\W]*\}\}/gm),
    an = b(/<%[\w\W]*|[\w\W]*%>/gm),
    rn = b(/\$\{[\w\W]*/gm),
    sn = b(/^data-[\-\w.\u00B7-\uFFFF]+$/),
  ...
  function St() {
    let r =
        arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : mn(),
      o = c((i) => St(i), "DOMPurify")
    if (
      ((o.version = "3.3.0"),
      (o.removed = []),
      !r || !r.document || r.document.nodeType !== ee.document || !r.Element)
    )
    ...
    let { document: l } = r,
      ...
      f = a.currentScript,
      {
        ...
        Element: Fe,
        NodeFilter: Y,
        NamedNodeMap: Rt = r.NamedNodeMap || r.MozNamedAttrMap,
        HTMLFormElement: Ot,
        DOMParser: yt,
        trustedTypes: te,
      } = r,
    ...
    let {
      ...
      qe = null,
      Ke = s({}, ["audio", "video", "img", "source", "image", "track"]),
      Oe = null,
      Ze = s({}, [
        "alt",
        "class",
      ...
      Le = null,
      Ft = s({}, [re, se, I], Ie),
      le = s({}, ["mi", "mo", "mn", "ms", "mtext"]),
      ce = s({}, ["annotation-xml"]),
      Ht = s({}, ["title", "style", "font", "a", "script"]),
      q = null,
      zt = ["application/xhtml+xml", "text/html"],
      Gt = "text/html",
      T = null,
      W = null,
      Wt = l.createElement("form"),
      Je = c(function (e) {
      ...
      be = c(function () {
        ...
        if (!(W && W === e)) {
          if (
            ...
            (e = w(e)),
            (q =
              zt.indexOf(e.PARSER_MEDIA_TYPE) === -1
                ? Gt
                : e.PARSER_MEDIA_TYPE),
            (T = q === "application/xhtml+xml" ? Ie : me),
            (d = D(e, "ALLOWED_TAGS") ? s({}, e.ALLOWED_TAGS, T) : Ge),
            (E = D(e, "ALLOWED_ATTR") ? s({}, e.ALLOWED_ATTR, T) : We),
            (Le = D(e, "ALLOWED_NAMESPACES")
              ? s({}, e.ALLOWED_NAMESPACES, Ie)
              : Ft),
            (Oe = D(e, "ADD_URI_SAFE_ATTR")
              ? s(w(Ze), e.ADD_URI_SAFE_ATTR, T)
              : Ze),
            (qe = D(e, "ADD_DATA_URI_TAGS")
              ? s(w(Ke), e.ADD_DATA_URI_TAGS, T)
              : Ke),
            (z = D(e, "FORBID_CONTENTS") ? s({}, e.FORBID_CONTENTS, T) : $e),
            (V = D(e, "FORBID_TAGS") ? s({}, e.FORBID_TAGS, T) : w({})),
            (ge = D(e, "FORBID_ATTR") ? s({}, e.FORBID_ATTR, T) : w({})),
            (H = D(e, "USE_PROFILES") ? e.USE_PROFILES : !1),
            ...
            H &&
              ((d = s({}, pt)),
              (E = []),
              H.html === !0 && (s(d, mt), s(E, dt)),
              H.svg === !0 && (s(d, Me), s(E, Pe), s(E, ue)),
              H.svgFilters === !0 && (s(d, we), s(E, Pe), s(E, ue)),
              H.mathMl === !0 && (s(d, xe), s(E, Tt), s(E, ue))),
            e.ADD_TAGS &&
              (typeof e.ADD_TAGS == "function"
                ? (k.tagCheck = e.ADD_TAGS)
                : (d === Ge && (d = w(d)), s(d, e.ADD_TAGS, T))),
            e.ADD_ATTR &&
              (typeof e.ADD_ATTR == "function"
                ? (k.attributeCheck = e.ADD_ATTR)
                : (E === We && (E = w(E)), s(E, e.ADD_ATTR, T))),
            e.ADD_URI_SAFE_ATTR && s(Oe, e.ADD_URI_SAFE_ATTR, T),
            e.FORBID_CONTENTS &&
              (z === $e && (z = w(z)), s(z, e.FORBID_CONTENTS, T)),
            Re && (d["#text"] = !0),
            x && s(d, ["html", "head", "body"]),
            d.table && (s(d, ["tbody"]), delete V.tbody),
            ...
            h === void 0 && (h = pn(te, f)),
              h !== null && typeof j == "string" && (j = h.createHTML(""))
          R && R(e), (W = e)
        }
      }, "_parseConfig"),
      Qe = s({}, [...Me, ...we, ...tn]),
        ...
        return Le[e.namespaceURI]
          ? e.namespaceURI === se
            ...
            ? t.namespaceURI === I
              ...
              : !!et[n]
            : e.namespaceURI === I
            ? (t.namespaceURI === se && !ce[u]) ||
              (t.namespaceURI === re && !le[u])
              ? !1
              : !et[n] && (Ht[n] || !Qe[n])
            : !!(q === "application/xhtml+xml" && Le[e.namespaceURI])
          : !1
      }, "_checkValidNamespace"),
      N = c(function (e) {
        K(o.removed, { element: e })
        try {
          ne(e).removeChild(e)
        } catch {
          bt(e)
      ...
      P = c(function (e, t) {
        try {
          K(o.removed, { attribute: t.getAttributeNode(e), from: t })
        } catch {
          K(o.removed, { attribute: null, from: t })
        }
      ...
      tt = c(function (e) {
        ...
        q === "application/xhtml+xml" &&
          ...
          (e =
            ...
            e +
            "</body></html>")
        let u = h ? h.createHTML(e) : e
        if (G === I)
          try {
            t = new yt().parseFromString(u, q)
          } catch {}
        if (!t || !t.documentElement) {
          t = de.createDocument(G, "template", null)
          try {
            t.documentElement.innerHTML = ye ? j : u
          } catch {}
        }
        let g = t.body || t.documentElement
        return (
          e &&
            n &&
            g.insertBefore(l.createTextNode(n), g.childNodes[0] || null),
          G === I
            ? Mt.call(t, x ? "html" : "body")[0]
            : x
            ? t.documentElement
            : g
        )
    ...
    let it = c(function (e) {
        let t = null
        if ((C(A.beforeSanitizeElements, e, null), De(e))) return N(e), !0
        let n = T(e.nodeName)
        if (
          (C(A.uponSanitizeElement, e, { tagName: n, allowedTags: d }),
          (oe &&
            e.hasChildNodes() &&
            ...
            (oe && e.nodeType === ee.comment && S(/<[/\w]/g, e.data)))
        )
          return N(e), !0
        if (
          !(k.tagCheck instanceof Function && k.tagCheck(n)) &&
          (!d[n] || V[n])
        ) {
          if (
            !V[n] &&
            rt(n) &&
            ((m.tagNameCheck instanceof RegExp && S(m.tagNameCheck, n)) ||
              (m.tagNameCheck instanceof Function && m.tagNameCheck(n)))
          )
            return !1
          if (Re && !z[n]) {
            let u = ne(e) || e.parentNode,
              g = Nt(e) || e.childNodes
            if (g && u) {
              let p = g.length
              for (let L = p - 1; L >= 0; --L) {
                ...
                ;(M.__removalCount = (e.__removalCount || 0) + 1),
                  u.insertBefore(M, Dt(e))
              }
            }
          }
          return N(e), !0
        }
        return (e instanceof Fe && !Bt(e)) ||
          ...
          : (U &&
              ...
              e.textContent !== t &&
                (K(o.removed, { element: e.cloneNode() }),
                (e.textContent = t))),
            C(A.afterSanitizeElements, e, null),
            !1)
      }, "_sanitizeElements"),
      at = c(function (e, t, n) {
        if (je && (t === "id" || t === "name") && (n in l || n in Wt)) return !1
        if (!(he && !ge[t] && S(xt, t))) {
          if (!(Be && S(Pt, t))) {
            if (
              ...
              if (!E[t] || ge[t]) {
                if (
                  !(
                    (rt(e) &&
                      ((m.tagNameCheck instanceof RegExp &&
                        S(m.tagNameCheck, e)) ||
                        (m.tagNameCheck instanceof Function &&
                          m.tagNameCheck(e))) &&
                      ((m.attributeNameCheck instanceof RegExp &&
                        S(m.attributeNameCheck, t)) ||
      ...
      rt = c(function (e) {
        return e !== "annotation-xml" && Ce(e, kt)
      }, "_isBasicCustomElement"),
      st = c(function (e) {
        C(A.beforeSanitizeAttributes, e, null)
        let { attributes: t } = e
        if (!t || De(e)) return
        let n = {
            attrName: "",
        ...
        for (; u--; ) {
          let g = t[u],
            { name: p, namespaceURI: L, value: M } = g,
            B = T(p),
            Ne = M,
            _ = p === "value" ? Ne : Jt(Ne)
          if (
            ...
            C(A.uponSanitizeAttribute, e, n),
            (_ = n.attrValue),
            Ve && (B === "id" || B === "name") && (P(p, e), (_ = Ut + _)),
            oe && S(/((--!?|])>)|<\/(style|title|textarea)/i, _))
          ) {
            P(p, e)
            continue
          }
          if (B === "attributename" && Ce(_, "href")) {
            P(p, e)
            continue
          }
          ...
          if (
            h &&
            typeof te == "object" &&
            typeof te.getAttributeType == "function" &&
            !L
          )
            switch (te.getAttributeType(lt, B)) {
              case "TrustedHTML": {
                _ = h.createHTML(_)
                break
              }
              case "TrustedScriptURL": {
                _ = h.createScriptURL(_)
                break
              }
            }
          if (_ !== Ne)
            try {
              L ? e.setAttributeNS(L, p, _) : e.setAttribute(p, _),
                De(e) ? N(e) : ut(o.removed)
            } catch {
              P(p, e)
            }
        }
        C(A.afterSanitizeAttributes, e, null)
      }, "_sanitizeAttributes"),
      Yt = c(function i(e) {
        let t = null,
          n = nt(e)
        for (C(A.beforeSanitizeShadowDOM, e, null); (t = n.nextNode()); )
          C(A.uponSanitizeShadowNode, t, null),
            it(t),
            st(t),
            t.content instanceof y && i(t.content)
        C(A.afterSanitizeShadowDOM, e, null)
      }, "_sanitizeShadowDOM")
    return (
      (o.sanitize = function (i) {
        let e =
          ...
          u = null,
          g = null
        if (((ye = !i), ye && (i = "<!-->"), typeof i != "string" && !ot(i)))
          if (typeof i.toString == "function") {
            if (((i = i.toString()), typeof i != "string"))
              throw J("dirty is not a string, aborting")
          } else throw J("toString is not a function")
        if (!o.isSupported) return i
        if (
          (Ae || be(e), (o.removed = []), typeof i == "string" && ($ = !1), $)
        ) {
          if (i.nodeName) {
            let M = T(i.nodeName)
            if (!d[M] || V[M])
          ...
          (t = tt("<!---->")),
            ...
            (n.nodeType === ee.element && n.nodeName === "BODY") ||
            n.nodeName === "HTML"
              ? (t = n)
              : t.appendChild(n)
        else {
          if (!F && !U && !x && i.indexOf("<") === -1)
            return h && ae ? h.createHTML(i) : i
          if (((t = tt(i)), !t)) return F ? null : ae ? j : ""
        }
        t && Se && N(t.firstChild)
        let p = nt($ ? i : t)
        for (; (u = p.nextNode()); )
          it(u), st(u), u.content instanceof y && Yt(u.content)
        if ($) return i
        if (F) {
          if (ie)
          ...
          return (
            (E.shadowroot || E.shadowrootmode) && (g = wt.call(a, g, !0)), g
          )
        }
        ...
        return (
          x &&
            ...
            S(At, t.ownerDocument.doctype.name) &&
            (L = "<!DOCTYPE " + t.ownerDocument.doctype.name + `>` + L),
          U &&
            fe([Te, Ee, _e], (M) => {
              L = Z(L, M, " ")
            }),
          h && ae ? h.createHTML(L) : L
        )
      }),
      ...
      (o.addHook = function (i, e) {
        typeof e == "function" && K(A[i], e)
      }),
      (o.removeHook = function (i, e) {
        if (e !== void 0) {
          let t = qt(A[i], e)
          return t === -1 ? void 0 : Kt(A[i], t, 1)[0]
        }
        return ut(A[i])
      }),
  ...
  function goodTube_helper_adsShowing() {
    ...
    if (goodTube_helper_watchingVideo()) {
      ...
      let sponsoredAdsElement = document.querySelector(
        ".ad-simple-attributed-string"
      )

      // If ads are showing
      if (
        (adsElement && adsElement.checkVisibility()) ||
        (sponsoredAdsElement && sponsoredAdsElement.checkVisibility())
      ) {
        return true
      }
  ...
  // Trigger a keyboard shortcut to mimic native input (API next/prev calls triggered detection issues).
  ...
  // Are we syncing the main Youtube player? Guard prevents pause/mute logic from tripping detection.
  ...
  // Shorts are always removed; the player background stays black.
  const goodTube_blackBackground = "true"
  ...
  let goodTube_playbackSpeed = goodTube_helper_getCookie(
    "goodTube_playbackSpeed"
  )
  ...
  function goodTube_youtube_hideShortsRealTime() {
    ...
    // Hide shorts buttons
    let shortsButtons = document.querySelectorAll(
      "yt-chip-cloud-chip-renderer:not(.goodTube_hidden):not(.goodTube_checked), yt-tab-shape:not(.goodTube_hidden):not(.goodTube_checked), ytd-guide-entry-renderer:not(.goodTube_checked)"
    )
  ...
  function goodTube_youtube_timestampLinks() {
    ...
    let timestampLinks = document.querySelectorAll(
      "#description a, ytd-comments .yt-core-attributed-string a, ytm-expandable-video-description-body-renderer a, .comment-content a"
    )
    ...
    timestampLinks.forEach((element) => {
      ...
      if (
        !element.classList.contains("goodTube_timestampLink") &&
        element.getAttribute("href") &&
        element.getAttribute("href").indexOf(goodTube_getParams["v"]) !== -1
      ) {
  ...
  let goodTube_youtube_pauseMuteVideos_timeout = 0
  function goodTube_youtube_pauseMuteVideos() {

    let adsShowing = false
    if (!goodTube_fallback) {
      adsShowing = !!goodTube_helper_adsShowing()
    }
    ...
    youtubeVideos.forEach((video) => {
      ...
      // Keep pausing/muting background videos to avoid phantom playback.
      else {
        if (
          !video.paused &&
          !goodTube_syncingPlayer &&
          ...
          if (!adsShowing || !video.closest("#movie_player")) {
            // Pause the video
            video.pause()
    ...
    if (goodTube_fallback) {
      ...
      nextDelay = 1000
    } else if (!goodTube_helper_watchingVideo()) {
      nextDelay = 500
    } else if (!adsShowing) {
      nextDelay = 250
    }
    ...
    // Loop this function
    goodTube_youtube_pauseMuteVideos_timeout = setTimeout(
  ...
  function goodTube_youtube_turnOffAutoplay() {
    ...
    let autoplayButton = document.querySelector(
  ...
  function goodTube_youtube_removeAreYouStillWatchingPopup() {
    ...
    dialogueBoxes.forEach((dialogueBox) => {
      ...
      if (
        dialogueBox.innerHTML.indexOf("Video paused. Continue watching?") !== -1
      ) {
  ...
  // Player functions
  // Init player
  let goodTube_player_init_timeout = 0
  function goodTube_player_init() {
    ...
    if (
      goodTube_page_api &&
      typeof goodTube_page_api.getVideoData === "function"
    ) {
    ...
    // We need to use this method so it doesn't mess with the browser history/back button.
    proxyIframe.contentWindow.location.replace(
      "https://wikipedia.org/wiki/Bruce_Lee?goodTubeProxy=1"
    )
  ...
  function goodTube_player_populatePlaylistInfo() {
    ...
    let playlistItems = document.querySelectorAll(
  ...
  // Load a video
  let goodTube_player_load_timeout = 0
  function goodTube_player_load() {
    ...
    // Include the start time from query params
    ...
    if (goodTube_firstLoad) {
      ...
      goodTube_player.contentWindow.postMessage(
        "old_goodTube_src_https://www.youtube.com/embed/" +
          goodTube_getParams["v"] +
          "?goodTubeEmbed=1&autoplay=1&goodTube_autoplay=" +
          goodTube_autoplay +
          "&goodTube_playbackSpeed=" +
          goodTube_playbackSpeed +
          startTimeParam,
    ...
    // Otherwise, for all other loads
      ...
      goodTube_player.contentWindow.postMessage(
        "old_goodTube_load_" + goodTube_getParams["v"] + "|||" + startTime,
        "*"
      )
    }
    ...
    // Play the video (Firefox can fail to auto-play without this).
  ...
  // Sync the starting time
  let goodTube_player_syncStartingTime_timeout = 0
  function goodTube_player_syncStartingTime() {
    ...
    if (!goodTube_playerIframeLoaded) {
      ...
      // Create a new timeout to try again
      goodTube_player_syncStartingTime_timeout = setTimeout(
        goodTube_player_syncStartingTime,
        100
      )
    ...
    if (
      goodTube_page_api &&
      typeof goodTube_page_api.getVideoData === "function" &&
      typeof goodTube_page_api.getCurrentTime === "function"
    ) {
      videoData = goodTube_page_api.getVideoData()
  ...
  function goodTube_player_clear(fallbackActive = false) {
    ...
    if (!goodTube_pip) {
      ...
      if (fallbackActive) {
        ...
        if (
          goodTube_page_api &&
          typeof goodTube_page_api.pauseVideo === "function" &&
          typeof goodTube_page_api.mute === "function"
        ) {
  ...
  function goodTube_player_skipTo(time, videoId = "") {
    ...
    goodTube_player.contentWindow.postMessage(
      "old_goodTube_skipTo_" + time + "|||" + videoId,
      "*"
    )
  }
  ...
  // Play
  let goodTube_player_play_timeout = 0
  function goodTube_player_play() {
    ...
    if (!goodTube_fallback) {
      goodTube_player.contentWindow.postMessage(
        "old_goodTube_play|||" + goodTube_getParams["v"],
        "*"
      )
    }
    // Otherwise, the "hide and mute ads" fallback is enabled
      ...
      if (
        goodTube_page_api &&
        typeof goodTube_page_api.playVideo === "function"
      ) {
  ...
  function goodTube_shortcuts_keypress(event) {
    ...
    allowedShortcuts.forEach((allowedShortcut) => {
      if (
        (keyPressed === allowedShortcut.key ||
          codePressed === allowedShortcut.code) &&
  ...
  function goodTube_nav_prev() {
    ...
    if (goodTube_playlist.length > 0 && goodTube_playlistIndex === 0) {
      ...
      goodTube_player.contentWindow.postMessage(
        "old_goodTube_skipTo_0|||" + goodTube_getParams["v"],
        "*"
      )
  ...
  function goodTube_init(retrying = false) {
    ...
    if (!document.body || !document.head) {
      ...
      // Create a new timeout
      goodTube_init_timeout = setTimeout(() => {
        goodTube_init(true)
      }, 1)
    }
  ...
  let goodTube_receiveMessage_timeout = 0
  function goodTube_receiveMessage(event) {
    ...
    // Save the playback speed as a cookie
      ...
      goodTube_helper_setCookie(
        "old_goodTube_playbackSpeed",
        event.data.replace("old_goodTube_playbackSpeed_", "")
      )
      goodTube_playbackSpeed = event.data.replace(
        "old_goodTube_playbackSpeed_",
        ""
      )
    }
    ...
    // Theater mode (toggle) - this should only work when not in fullscreen
      ...
      event.data === "old_goodTube_theater" &&
    ...
    // Sync main player (only if we're viewing a video page AND the "hide and mute ads" fallback is inactive)
      ...
      event.data.indexOf("old_goodTube_syncMainPlayer_") !== -1 &&
      goodTube_helper_watchingVideo() &&
      !goodTube_fallback
    ) {
      // Parse the data
      let bits = event.data
        .replace("old_goodTube_syncMainPlayer_", "")
        .split("|||")
      let syncTime = bits[0]
      let videoId = bits[1]
      ...
      if (
        !goodTube_page_api ||
        typeof goodTube_page_api.seekTo !== "function" ||
        typeof goodTube_page_api.getVideoData !== "function" ||
        typeof goodTube_page_api.pauseVideo !== "function" ||
        typeof goodTube_page_api.playVideo !== "function"
      ) {
      ...
      if (
        youtubeVideoElement &&
        Math.floor(youtubeVideoElement.currentTime) !== Math.floor(syncTime) &&
        !goodTube_helper_adsShowing()
      ) {
    ...
    // Enable "hide and mute ads" fallback
      ...
      if (
        document.body &&
        !document.body.classList.contains("goodTube_fallback")
      ) {
    ...
    // Sync the aspect ratio
      ...
      // Otherwise, for all other videos
        ...
        let aspectRatio = event.data
          .replace("old_goodTube_syncAspectRatio_", "")
          .split("_")
  ...
  let goodTube_actions_timeout = 0
  let goodTube_actions_activeInterval = 100
  let goodTube_actions_idleInterval = 1000

  // Actions
  function goodTube_actions() {
    let watchingVideo = goodTube_helper_watchingVideo()
    let nextInterval =
      document.hidden || !watchingVideo
        ? goodTube_actions_idleInterval
        : goodTube_actions_activeInterval
    ...
    goodTube_actions_timeout = setTimeout(goodTube_actions, nextInterval)
  }
  ...
  function goodTube_hideAndMuteAdsFallback_enable() {
    ...
    let draggableCaptions = document.querySelector(
    ...
    if (!existingOverlay) {
      ...
      // Add it to the page
      let injectElement = document.querySelector(
  ...
  function goodTube_hideAndMuteAdsFallback_disable() {
    ...
    if (videoElement) {
      ...
      if (
        goodTube_page_api &&
        typeof goodTube_page_api.unMute === "function" &&
        typeof goodTube_page_api.setVolume === "function" &&
        typeof goodTube_page_api.getVolume === "function"
      ) {
        // Restore the volume (only if muted, otherwise leave it alone)
        if (
          videoElement.volume <= 0 ||
          videoElement.muted ||
          goodTube_page_api.getVolume() === 0
        ) {
  ...
  // Init the autoplay actions to sync the embedded player and cookie with the normal button
  let goodTube_hideAndMuteAdsFallback_autoPlay_init_timeout = setTimeout(
    () => {},
    0
  )
  function goodTube_hideAndMuteAdsFallback_autoPlay_init() {
    ...
    if (autoplayButton) {
      ...
      autoplayButton.addEventListener("click", () => {
        ...
        goodTube_player.contentWindow.postMessage(
          "old_goodTube_autoplay_" + oppositeValue,
          "*"
        )
      })
    }
    // Otherwise, keep trying until we find the autoplay button
      ...
      // Create a new timeout
      goodTube_hideAndMuteAdsFallback_autoPlay_init_timeout = setTimeout(
        goodTube_hideAndMuteAdsFallback_autoPlay_init,
        100
      )
    }
  ...
  // Sync autoplay
  let goodTube_hideAndMuteAdsFallback_syncAutoplay_timeout = setTimeout(
    () => {},
    0
  )
  function goodTube_hideAndMuteAdsFallback_syncAutoplay() {
    ...
    // Otherwise, keep trying until we find the autoplay button
      ...
      // Create a new timeout
      goodTube_hideAndMuteAdsFallback_syncAutoplay_timeout = setTimeout(
        goodTube_hideAndMuteAdsFallback_syncAutoplay,
        100
      )
    }
  ...
  // Play video
  let goodTube_hideAndMuteAdsFallback_play_timeout = 0
  ...
  let goodTube_iframe_init_timeout = 0
  function goodTube_iframe_init(retrying = false) {
    ...
    if (!document.body || !document.head) {
      ...
      // Create a new timeout
      goodTube_iframe_init_timeout = setTimeout(() => {
        goodTube_iframe_init(true)
      }, 1)
    }
    // Otherwise, the DOM is ready
    else {
  ...
  // Init when DOM is ready
  let goodTube_iframe_init_domReady_timeout = 0
  function goodTube_iframe_init_domReady() {
    ...
    if (
      goodTube_iframe_api &&
      typeof goodTube_iframe_api.getVideoData === "function"
    ) {
    ...
    if (!videoData) {
      ...
      // Create a new timeout
      goodTube_iframe_init_domReady_timeout = setTimeout(
        goodTube_iframe_init_domReady,
        1
      )
  ...
  let goodTube_iframe_actions_timeout = 0
  let goodTube_iframe_actions_activeInterval = 100
  let goodTube_iframe_actions_idleInterval = 1000

  // Actions
  function goodTube_iframe_actions() {
    let nextInterval = document.hidden
      ? goodTube_iframe_actions_idleInterval
      : goodTube_iframe_actions_activeInterval
    ...
    goodTube_iframe_actions_timeout = setTimeout(
      goodTube_iframe_actions,
      nextInterval
    )
  }
  ...
  function goodTube_iframe_playbackSpeed() {
    ...
    if (typeof goodTube_getParams["goodTube_playbackSpeed"] !== "undefined") {
      ...
      if (
        goodTube_iframe_api &&
        typeof goodTube_iframe_api.setPlaybackRate === "function"
      ) {
        goodTube_iframe_api.setPlaybackRate(
          parseFloat(goodTube_getParams["goodTube_playbackSpeed"])
        )
      }
    }
    ...
    setInterval(() => {
      ...
      if (
        goodTube_iframe_api &&
        typeof goodTube_iframe_api.getPlaybackRate === "function"
      ) {
        // Tell the top frame to save the playback speed
        window.top.postMessage(
          "old_goodTube_playbackSpeed_" + goodTube_iframe_api.getPlaybackRate(),
          "*"
        )
      }
    }, 500)
  ...
  function goodTube_iframe_fixLinks() {
    ...
    let videoLinks = document.querySelectorAll(
      ".ytp-videowall-still:not(.goodTube_fixed), .ytp-ce-covering-overlay:not(.goodTube_fixed)"
    )
  ...
  // Add custom buttons
  let goodTube_iframe_addCustomButtons_timeout = 0
  function goodTube_iframe_addCustomButtons() {
    ...
    if (!playButton) {
      ...
      // Create a new timeout
      goodTube_iframe_addCustomButtons_timeout = setTimeout(
        goodTube_iframe_addCustomButtons,
        100
      )
    ...
    if (subtitlesButton) {
      ...
      goodTube_helper_insertAdjacentHTML(
        subtitlesButton,
        "beforebegin",
        '<button class="ytp-button ytp-autonav-toggle" id="goodTube_autoplayButton" data-version="old"><div class="ytp-autonav-toggle-button-container"><div class="ytp-autonav-toggle-button" aria-checked="' +
          goodTube_getParams["goodTube_autoplay"] +
          '"></div></div></button>'
      )
      ...
      if (autoplayButton) {
        autoplayButton.addEventListener("click", function () {
          ...
          let innerButton = autoplayButton.querySelector(
  ...
  // Add custom events
  let goodTube_iframe_addCustomEvents_timeout = 0
  function goodTube_iframe_addCustomEvents() {
    ...
    if (!videoElement) {
      ...
      // Create a new timeout
      goodTube_iframe_addCustomEvents_timeout = setTimeout(
        goodTube_iframe_addCustomEvents,
        100
      )
  ...
  function goodTube_iframe_addKeyboardShortcuts() {
    ...
    document.addEventListener("keydown", function (event) {
      ...
      // Prev video ("shift+p" or "media track previous")
        ...
        (keyPressed === "p" && event.shiftKey) ||
        keyPressed === "mediatrackprevious"
      ) {
      ...
      // Next video ("shift+n" or "media track next")
        ...
        (keyPressed === "n" && event.shiftKey) ||
        keyPressed === "mediatracknext"
      ) {
  ...
  function goodTube_iframe_loadVideo(videoId, startSeconds) {
    ...
    if (
      goodTube_iframe_api &&
      typeof goodTube_iframe_api.loadVideoById === "function"
    ) {
      // Load the video
  ...
  let goodTube_iframe_receiveMessage_timeout = 0
  function goodTube_iframe_receiveMessage(event) {
    ...
    if (!document.body || !document.head) {
      ...
      // Create a new timeout
      goodTube_iframe_receiveMessage_timeout = setTimeout(() => {
        goodTube_iframe_receiveMessage(event)
      }, 100)
    ...
    // Show the end screen thumbnails
      ...
      if (
        document.body &&
        document.body.classList.contains("goodTube_hideEndScreen")
      ) {
    ...
    // Keyboard shortcut
      ...
      if (videoElement) {
        ...
        let keyData = event.data
          .replace("old_goodTube_shortcut_", "")
          .split("_")
  ...
  // Go fullscreen
  let goodTube_iframe_fullscreen_timeout = 0
  function goodTube_iframe_fullscreen() {
    ...
    // Otherwise, we didn't find it
      ...
      // Create a new timeout to try again
      goodTube_iframe_fullscreen_timeout = setTimeout(
        goodTube_iframe_fullscreen,
        100
      )
    }
  ...
  // Set autoplay
  let goodTube_iframe_setAutoplay_timeout = 0
  function goodTube_iframe_setAutoplay(enabled) {
    ...
    // Otherwise, we didn't find it
      ...
      // Create a new timeout to try again
      goodTube_iframe_setAutoplay_timeout = setTimeout(() => {
        goodTube_iframe_setAutoplay(enabled)
      }, 100)
    }
  }

  // Skip to time
  let goodTube_iframe_skipTo_timeout = 0
  ...
  // Pause
  let goodTube_iframe_pause_timeout = 0
  ...
  // Mute
  let goodTube_iframe_mute_timeout = 0
  ...
  // Unmute
  let goodTube_iframe_unmute_timeout = 0
  ...
  // Play
  let goodTube_iframe_play_timeout = 0
  function goodTube_iframe_play(videoId) {
    ...
    if (!videoData || videoId !== videoData.video_id) {
      ...
      // Create a new timeout to try again
      goodTube_iframe_play_timeout = setTimeout(() => {
        goodTube_iframe_play(videoId)
      }, 100)
    ...
    if (
      goodTube_iframe_api &&
      typeof goodTube_iframe_api.playVideo === "function"
    ) {
      // Force the video to play
  ...
  function goodTube_iframe_syncMainPlayer(syncToEnd = false) {
    ...
    if (videoElement) {
      ...
      window.top.postMessage(
        "old_goodTube_syncMainPlayer_" + syncTime + "|||" + videoData.video_id,
        "*"
      )
    }
  }
  ...
  function goodTube_iframe_checkImmersiveTranslation() {
    ...
    if (
      !goodTube_iframe_checkImmersiveTranslation_classAdded &&
      document.querySelector('style[data-id^="immersive-translate"]')
    ) {
  ...
  let goodTube_proxyIframe_init_timeout = 0
  function goodTube_proxyIframe_init() {
    ...
    if (!document.body || !document.head) {
      ...
      // Create a new timeout
      goodTube_proxyIframe_init_timeout = setTimeout(
  ...
  // Receive a message from the parent window
  let goodTube_proxyIframe_receiveMessage_timeout = 0
  function goodTube_proxyIframe_receiveMessage(event) {
    ...
    if (!document.body || !document.head) {
      ...
      // Create a new timeout
      goodTube_proxyIframe_receiveMessage_timeout = setTimeout(() => {
        goodTube_proxyIframe_receiveMessage(event)
      }, 100)
    }
    ...
    if (youtubeIframe) {
      ...
      if (event.data.indexOf("old_goodTube_src_") !== -1) {
        ...
        youtubeIframe.contentWindow.location.replace(
          event.data.replace("old_goodTube_src_", "")
        )
      }
  ...
  function goodTube_start() {
    ...
    if (
      ...
      window.location.href.indexOf("youtube") !== -1
    ) {
      goodTube_init()
    }
    // Proxy iframe embed
